                ...
                <div className="row flex">
                  ...
                  <div className="col__2">
                    <div className="meta">
                      ...
                      >
                        Xin chào đến với Như Anh Shop!!!
                      </span>
                      <p>
                        Như Anh shop là một thương hiệu thời trang Việt Nam dành
                        cho giới trẻ.
                        <br />
                      ...
                      <p>
                        <h1>1"</h1> <h2>Như Anh shop </h2>mang đến cho khách hàng
                      ...
                      <p>
                        <h1>3"</h1> <h2>Như Anh shop </h2>Luôn duy trì chế độ bảo hành 365 ngày đối với mọi sản phẩm
                      </p>
